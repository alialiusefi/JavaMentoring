...
final public class GiftCertificate extends Entity {
    ...
    public GiftCertificate(long id, String name, String description, double price, LocalDate dateOfCreation,
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.price, price) == 0 &&
                durationTillExpiry == that.durationTillExpiry &&
    ...
    public int hashCode() {
        return Objects.hash(super.hashCode(), name, description, price,
                dateOfCreation, dateOfModification, durationTillExpiry);
    }
