...
const Home = (props) => {
    ...
    const [certificateDropDownValue, setcertificateDropDownValue] = useState("ALL");
    const [isLoggedIn, setisLoggedIn] = useState(false);
    const [username, setusername] = useState(null);
    const [user_id, setuser_id] = useState(null);
    const [user_role, setuser_role] = useState(null);
    const [selectedGiftCertificate, setselectedGiftCertificate] = useState(null);
    ...
    useEffect(() => {
        ...
        if (decodedToken != null) {
            if (!(decodedToken.exp < now.getTime() / 1000)) {
                ...
                setuser_role(decodedToken.role);
            }
        }
    ...
    return (
        <div>
            <Header isLoggedIn={isLoggedIn} username={username}
                    location={props.location.pathname} role={user_role}
            ...
            <Switch>
                ...
                <Route path="/add">
                    <AddEditGiftCertificate handleAddCertificate={handleAddCertificate}/>
                </Route>
                <Route path="/edit">
                    <AddEditGiftCertificate certificate={selectedGiftCertificate}
                ...
                <Route path="/giftcertificates">
                    <div className="container text-center">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-4">
                                    <SearchMenuForm certificateDropDownValue={certificateDropDownValue}
                                                    handleGetAllCertificates={handleGetAllCertificates}
                                                    role={user_role}/>
                                </div>
                                <div className="col">
                        ...
                        <div className="container">
                            <ListOfGiftCertificates giftcertificates={giftCertificates}
                                                    handleGetCertificatesByTagName={handleGetCertificatesByTagName}
                                                    handleGetAllCertificates={handleGetAllCertificates}
                                                    setPageSize={setPageSize}
                                                    setPageNumber={setPageNumber}
                                                    role={user_role}
                                                    setSelectedGiftCertificate={setSelectedGiftCertificate}
                                                    handleDeleteCertificate={handleDeleteCertificateModal}
                                                    handleBuyCertificate={handleBuyCertificate}
                            />
                        </div>
                        <div className="container-fluid">
                            <div className="row justify-content-center">
                                <div className="col-3">
                                    <PaginationSize handleChangePageSize={handleChangePageSize}/>
                                </div>
                                <div className="col-6">
...
const setSelectedGiftCertificate = (certificate) => {
...
const handleDeleteCertificateModal = (certificate) => {
...
const handleGetAllCertificates = (filterAllOrMy, pageSize, pageNumber) => {
...
const handleGetCertificatesByTagName = (tagID, tagName) => {
...
const handleUpdateCertificate = (name, description, price, durationTillExpiry, tags, id) => {
...
const handleAddCertificate = (name, description, price, durationTillExpiry, tags) => {
